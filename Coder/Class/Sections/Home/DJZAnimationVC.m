...
//  Coder
//
//  Created by 张得军 on 2020/6/22.
//  Copyright © 2020 张得军. All rights reserved.
//

#import "DJZAnimationVC.h"
#import "DCPathButton.h"
#import "DWBubbleMenuButton.h"
#import "MCFireworksButton.h"

@interface DJZAnimationVC ()<DCPathButtonDelegate>
...
- (void)viewDidLoad {
   ...
   NSArray *titles = [NSArray arrayWithObjects:@"Path",@"钉钉",@"点赞", nil];
    for (int i=0; i<titles.count; i++) {
        UIButton *btn = [[UIButton alloc] initWithFrame:CGRectMake(100 + 80 * i, 100, 50, 30)];
        btn.tag = i;
...
-(void)clickGoodAnimation{
    ...
    if (!_goodBtn) {
        _goodBtn = [[MCFireworksButton alloc] initWithFrame:CGRectMake(kDJZScreenWidth/2-25, kDJZScreenHeight/2-25, 50, 50)];
